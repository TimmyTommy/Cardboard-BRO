...
public class GameView extends View implements InputDeviceListener {
    ...
    private class Ship extends Sprite {
        ...
        public boolean onGenericMotionEvent(MotionEvent event) {
            if (0 == mDPadState) {
                // Process all historical movement samples in the batch. TODO
        ...
        private void updateHeading() {
            ...
            System.out.println("=================================");
            System.out.println("mHeadingX: " + mHeadingX);
            System.out.println("mHeadingY: " + mHeadingY);
            System.out.println("mHeadingMagnitude: " + mHeadingMagnitude);
        }
