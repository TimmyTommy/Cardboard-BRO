...
public class Line {
    ...
    public Line(int lineProgramm) {
        ...
        GlProgram = lineProgramm;
//        //int vertexShader = ShaderFunctions.loadGLShader(GLES20.GL_VERTEX_SHADER, VertexShaderCode);
//        int fragmentShader = ShaderFunctions.loadGLShader(GLES20.GL_FRAGMENT_SHADER, FragmentShaderCode);
